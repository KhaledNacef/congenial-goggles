  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', backgroundColor: '#FCF6F5FF', borderRadius: 20, marginLeft: 3, border: '1px solid black' }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', padding: '10px' }}>
        <Button onClick={() => handleViewChange('create')} variant="contained"  style={{ fontFamily: 'Kanit', fontWeight: 600, margin: '10px',backgroundColor: '#89ABE3FF',color:'#FCF6F5FF' }}>Ajouter un PC</Button>
        ...
        <Button onClick={() => {  handleViewChange('ref')}} variant="contained"  style={{ fontFamily: 'Kanit', fontWeight: 600, margin: '10px',backgroundColor: '#89ABE3FF',color:'#FCF6F5FF' }}>PC refusé</Button>
        <Button onClick={() => { handleViewChange('fixed') }} variant="contained"  style={{ fontFamily: 'Kanit', fontWeight: 600, margin: '10px',backgroundColor: '#89ABE3FF',color:'#FCF6F5FF' }}>PC réparé</Button>
        <Button onClick={() => { handleViewChange('waiting') }} variant="contained"  style={{ fontFamily: 'Kanit', fontWeight: 600, margin: '10px',backgroundColor: '#89ABE3FF',color:'#FCF6F5FF' }}>PC en attente</Button>
        <Button onClick={() => {handleViewChange('all'); }} variant="contained"  style={{ fontFamily: 'Kanit', fontWeight: 600, margin: '10px',backgroundColor: '#89ABE3FF',color:'#FCF6F5FF' }}>Tous les PC</Button>
