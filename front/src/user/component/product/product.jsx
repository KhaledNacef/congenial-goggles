  ...
  return (
    <div style={{ width: '100%', height: '100vh', backgroundColor: '#FCF6F5FF', borderRadius: 20, marginLeft: 3, border: '1px solid black' }}>
      <Box sx={{ boxShadow: 20, display: 'flex', flexDirection: 'row', marginLeft: 'auto', marginRight: 'auto', border: '1px solid grey', borderRadius: 10, padding: 1, backgroundColor: 'white', margin: 'auto', height: 65, marginBottom: 5, width: '95%', maxWidth: 1200, marginTop: 10 }}>
        <Button onClick={() => changeview('create')} variant="contained"  style={{ fontFamily: 'Kanit', fontWeight: 500, margin: '10px', flex: 1,backgroundColor: '#89ABE3FF',color:'black' }}>AJOUTER UN PRODUIT</Button>
        <Button onClick={() => changeview('all')} variant="contained"  style={{ fontFamily: 'Kanit', fontWeight: 500, margin: '10px', flex: 1,backgroundColor: '#89ABE3FF',color:'black' }}>TOUS LES PRODUITS</Button>
        <Button onClick={() => changeview('sold')} variant="contained"  style={{ fontFamily: 'Kanit', fontWeight: 500, margin: '10px', flex: 1,backgroundColor: '#89ABE3FF',color:'black' }}>PRODUITS VENDUS</Button>
